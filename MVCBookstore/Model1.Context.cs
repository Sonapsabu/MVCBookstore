...
namespace MVCBookstore
{
    ...
    public partial class MVCProjectEntities : DbContext
    {
        ...
        public virtual ObjectResult<sp_selectbook_Result> sp_selectbook(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_selectbook_Result>("sp_selectbook", idParameter);
        }
    }
}
